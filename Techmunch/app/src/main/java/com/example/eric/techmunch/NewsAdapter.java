...
/**
 * NewsAdapter creates a list item layout for each news story in the data source (a list of News
 * objects). These list item layouts will be provided to an adapter view like ListView to be
 * displayed to the user.
 */
public class NewsAdapter extends ArrayAdapter<News> {
    public NewsAdapter(Context context, List<News> news) { super(context, 0, news); }
